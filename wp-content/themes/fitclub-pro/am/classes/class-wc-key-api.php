...
class Api_Manager_theme_Fitclub_Key {
	...
	public function activate( $args ) {
		...
		$defaults = array(
			'request' 			=> 'activation',
			'product_id' 		=> AMET()->ame_product_id,
			'instance' 			=> AMET()->ame_instance_id,
			'platform' 			=> AMET()->ame_domain,
			'software_version' 	=> AMET()->ame_software_version
			);
