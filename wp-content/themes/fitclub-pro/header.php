		...
		<header id="masthead" class="site-header" role="banner">
			<div class="header-wrapper clearfix">
				<div class="tg-container">
					...
					<?php if( ( get_theme_mod( 'fitclub_logo_placement', 'header_text_only' ) == 'show_both' || get_theme_mod( 'fitclub_logo_placement', 'header_text_only' ) == 'header_logo_only' ) && get_theme_mod( 'fitclub_logo', '' ) != '') {	?>
						<div class="logo">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img style="max-width: 67%;" src="<?php echo esc_url(get_theme_mod('fitclub_logo' )); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /></a>
                            <label class="city_choose_label"><span>Ваш город:</span>
                                <select name="city_choose" id="city_choose">
                                    <option value="borispol">Борисполь</option>
                                    <option value="brovary" selected>Бровары</option>
                                </select>
                            </label>
